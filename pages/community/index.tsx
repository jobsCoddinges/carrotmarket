    ...
    <div className="px-4 py-16 space-y-8">
      {[1, 2, 3, 4, 5, 6].map((_, i) => (
        <div key={i} className="flex flex-col items-start">
          ...
          <div className="mt-5 flex items-center justify-between w-full tegra500 font-medium text-xs">
            <span>니꼬</span>
            <span>18시간 전</span>
          </div>
      ...
      <button className="fixed cursor-pointer bottom-[35px] right-5 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 cursor-pointer transition-colors">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
