      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid   w-full grid-cols-2 mt-8 ">
            <button
              className={cls(
                "pb-4 w-full font-medium text-sm ",
                method === "email"
                  ? " font-bold border-orange-500 border-b-2 text-orange-500"
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 gap-3 mt-2">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-500 hover:text-white">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
